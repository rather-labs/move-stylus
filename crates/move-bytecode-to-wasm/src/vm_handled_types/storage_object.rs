...
pub struct FrozenStorageObject;

impl VmHandledType for FrozenStorageObject {
    const IDENTIFIER: &str = "FrozenStorageObject";
...
pub struct OwnedStorageObject;

impl VmHandledType for OwnedStorageObject {
    const IDENTIFIER: &str = "OwnedStorageObject";
...
pub struct SharedStorageObject;

impl VmHandledType for SharedStorageObject {
    const IDENTIFIER: &str = "SharedStorageObject";
