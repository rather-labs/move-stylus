...
pub fn translate_function(
    ...
    let mut flow_result: Result<(), TranslationError> = Ok(());

    // This block wraps the entire function's control flow. When a Ret instruction is encountered,
    // instead of returning directly, we store the result in a local variable and branch back to this block.
    // After the flow completes, the result is loaded from the local and pushed onto the stack to match the function's return type.
    let result_local_id = module.locals.add(ValType::I32);
    builder.block(None, |result_block| {
    ...
    // If the function has return values, push the return local to the stack
    if !function_information.results.is_empty() {
        ...
        Flow::IfElse {
            ...
            builder.block(None, |join| {
                ...
                join.block(None::<ValType>, |guard| {
                    ...
                    // ELSE (inside guard)
                    inner_result = translate_flow(ctx, guard, module, else_body, functions_to_link);
                    guard.br(join_id); // reconverge
                });
                if inner_result.is_ok() {
                    // THEN (after guard)
                    inner_result = translate_flow(ctx, join, module, then_body, functions_to_link);
                }
            });
            inner_result?;
        }
...
fn translate_instruction(
    ...
    let return_type = translate_flow_ctx
        .function_information
        .signature
        .get_return_wasm_types()
        .first()
        .copied();
    ...
    match instruction {
        ...
        Bytecode::LdU64(literal) => {
            // Check if the upper 16 bits of the u64 are set to 0x8000 (tag-bit),
            // which indicates the value may represent a special `clever error` generated by the #[error] macro.
            // Refer to: https://move-book.com/reference/abort-and-assert/clever-errors#clever-errors-and-macros
            if (literal >> 48) == 0x8000 {
                // Extract the constant value index from the lower 16 bits
                ...
                // It may happen that the upper 16 bits are 0x8000 but the u64 does not represent a `clever error`.
        ...
        Bytecode::Ret => {
            ...
            prepare_function_return(
                ...
                compilation_ctx,
                translate_flow_ctx.result_block_id,
                translate_flow_ctx.result_local_id,
            )?;
        ...
        Bytecode::Add => {
            ...
            match t1 {
                ...
                IntermediateType::IU16 => IU16::add(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU32 => IU32::add(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU64 => IU64::add(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU128 => IU128::add(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU256 => IU256::add(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
        ...
        Bytecode::Sub => {
            ...
            match t1 {
                ...
                IntermediateType::IU16 => IU16::sub(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU32 => IU32::sub(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU64 => IU64::sub(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU128 => IU128::sub(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU256 => IU256::sub(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
        ...
        Bytecode::Mul => {
            ...
            match t1 {
                ...
                IntermediateType::IU16 => IU16::mul(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU32 => IU32::mul(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU64 => IU64::mul(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU128 => IU128::mul(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU256 => IU256::mul(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
        ...
        Bytecode::Div => {
            ...
            match t1 {
                ...
                IntermediateType::IU128 => IU128::div(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU256 => IU256::div(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
        ...
        Bytecode::Mod => {
            ...
            match t1 {
                ...
                IntermediateType::IU128 => IU128::remainder(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU256 => IU256::remainder(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
        ...
        Bytecode::Shl => {
            ...
            let t = types_stack.pop()?;
            match t {
                IntermediateType::IU8 => IU8::bit_shift_left(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU16 => IU16::bit_shift_left(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU32 => IU32::bit_shift_left(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU64 => IU64::bit_shift_left(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU128 => IU128::bit_shift_left(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU256 => IU256::bit_shift_left(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
        ...
        Bytecode::Shr => {
            ...
            let t = types_stack.pop()?;
            match t {
                IntermediateType::IU8 => IU8::bit_shift_right(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU16 => IU16::bit_shift_right(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU32 => IU32::bit_shift_right(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU64 => IU64::bit_shift_right(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU128 => IU128::bit_shift_right(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
                ...
                IntermediateType::IU256 => IU256::bit_shift_right(
                    builder,
                    module,
                    compilation_ctx,
                    runtime_error_data,
...
fn call_indirect(
    ...
    builder.add_propagate_error_instructions(compilation_ctx, None, caller_return_type);
...
fn add_cache_storage_object_instructions(
    ...
    function_return_type: Option<ValType>,
) -> Result<(), TranslationError> {
