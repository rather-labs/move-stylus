...
mod comparisons_u8 {
    ...
    declare_fixture!("comparisons_u8", "tests/operations_comparisons/uint_8.move");
...
mod comparisons_u16 {
    ...
    declare_fixture!(
        "comparisons_u16",
        "tests/operations_comparisons/uint_16.move"
    );
...
mod comparisons_u32 {
    ...
    declare_fixture!(
        "comparisons_u32",
        "tests/operations_comparisons/uint_32.move"
    );
...
mod comparisons_u64 {
    ...
    declare_fixture!(
        "comparisons_u64",
        "tests/operations_comparisons/uint_64.move"
    );
...
mod comparisons_u128 {
    ...
    declare_fixture!(
        "comparisons_u128",
        "tests/operations_comparisons/uint_128.move"
    );
...
mod comparisons_u256 {
    ...
    declare_fixture!(
        "comparisons_u256",
        "tests/operations_comparisons/uint_256.move"
    );
