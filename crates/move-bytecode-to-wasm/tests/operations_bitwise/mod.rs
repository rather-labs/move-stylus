...
mod uint_8 {
    ...
    declare_fixture!("bitwise_uint_8", "tests/operations_bitwise/uint_8.move");
...
mod uint_16 {
    ...
    declare_fixture!("bitwise_uint_16", "tests/operations_bitwise/uint_16.move");
...
mod uint_32 {
    ...
    declare_fixture!("bitwise_uint_32", "tests/operations_bitwise/uint_32.move");
...
mod uint_64 {
    ...
    declare_fixture!("bitwise_uint_64", "tests/operations_bitwise/uint_64.move");
...
mod uint_128 {
    ...
    declare_fixture!("bitwise_uint_128", "tests/operations_bitwise/uint_128.move");
...
mod uint_256 {
    ...
    declare_fixture!("bitwise_uint_256", "tests/operations_bitwise/uint_256.move");
