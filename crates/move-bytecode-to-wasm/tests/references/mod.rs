...
mod reference_bool {
    ...
    declare_fixture!("references_bool", "tests/references/bool.move");
...
mod reference_uint_8 {
    ...
    declare_fixture!("references_uint_8", "tests/references/uint_8.move");
...
mod reference_uint_16 {
    ...
    declare_fixture!("references_uint_16", "tests/references/uint_16.move");
...
mod reference_uint_32 {
    ...
    declare_fixture!("references_uint_32", "tests/references/uint_32.move");
...
mod reference_uint_64 {
    ...
    declare_fixture!("references_uint_64", "tests/references/uint_64.move");
...
mod reference_uint_128 {
    ...
    declare_fixture!("references_uint_128", "tests/references/uint_128.move");
...
mod reference_uint_256 {
    ...
    declare_fixture!("references_uint_256", "tests/references/uint_256.move");
...
mod reference_vec_8 {
    ...
    declare_fixture!("references_vec_8", "tests/references/vec_8.move");
...
mod reference_vec_64 {
    ...
    declare_fixture!("references_vec_64", "tests/references/vec_64.move");
...
mod reference_vec_256 {
    ...
    declare_fixture!("references_vec_256", "tests/references/vec_256.move");
...
mod reference_structs {
    ...
    declare_fixture!("references_structs", "tests/references/structs.move");
...
mod reference_structs_generic {
    ...
    declare_fixture!(
        "references_structs_generic",
        "tests/references/structs_generic.move"
    );
...
mod external_struct {
    ...
    declare_fixture!("references_external_struct", "tests/references/external");
