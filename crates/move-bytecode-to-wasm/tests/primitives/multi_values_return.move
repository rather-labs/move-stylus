...
entry fun get_constants(): (u256, u64, u32, u8, bool, address, vector<u32>, vector<u128>) {
  (INT_U256, INT_U64, INT_U32, INT_U8, INT_BOOL, ADDRESS_AS_CONST, VECTOR_U32, VECTOR_U128)
}

entry fun get_constants_reversed(): (vector<u128>, vector<u32>, address, bool, u8, u32, u64, u256) {
  (VECTOR_U128, VECTOR_U32, ADDRESS_AS_CONST, INT_BOOL, INT_U8, INT_U32, INT_U64, INT_U256)
}

entry fun get_constants_nested(): (u256, u64, u32, u8, bool, address, vector<u32>, vector<u128>) {
  get_constants_inner()
}
