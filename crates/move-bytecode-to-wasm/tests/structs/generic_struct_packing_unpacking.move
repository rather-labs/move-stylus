...
public fun echo_foo_unpack(foo: Foo<u32>): (address, bool, u8, u16, u32, u64, u128, u256, u16, u128) {
    (
        foo.q,
        foo.t,
        foo.u,
...
public fun echo_bar_unpack(bar: Bar<vector<u32>>): (address, vector<u32>, vector<u128>, bool, u8, u16, u32, u64, u128, u256, u16, vector<u256>, u16, u128) {
    (
        bar.q,
        bar.r,
        bar.s,
