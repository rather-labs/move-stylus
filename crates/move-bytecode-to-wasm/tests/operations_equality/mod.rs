...
mod primitives {
    ...
    declare_fixture!("equality", "tests/operations_equality/primitives.move");
...
mod vector {
    ...
    declare_fixture!("equality_vectors", "tests/operations_equality/vectors.move");
...
mod references {
    ...
    declare_fixture!(
        "equality_references",
        "tests/operations_equality/references.move"
    );
...
mod structs {
    ...
    declare_fixture!("equality_structs", "tests/operations_equality/structs.move");
...
mod external_structs {
    ...
    declare_fixture!(
        ...
        "tests/operations_equality/external"
    );
...
mod enums {
    ...
    declare_fixture!("equality_enums", "tests/operations_equality/enums.move");
