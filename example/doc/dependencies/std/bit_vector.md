...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/std/bit_vector.md#std_bit_vector_new">new</a>(<a href="../../dependencies/std/bit_vector.md#std_bit_vector_length">length</a>: u64): <a href="../../dependencies/std/bit_vector.md#std_bit_vector_BitVector">BitVector</a> {
    ...
    <b>let</b> <b>mut</b> <a href="../../hello_world/counter.md#hello_world_counter">counter</a> = 0;
    <b>let</b> <b>mut</b> bit_field = vector::empty();
    <b>while</b> (<a href="../../hello_world/counter.md#hello_world_counter">counter</a> &lt; <a href="../../dependencies/std/bit_vector.md#std_bit_vector_length">length</a>) {
        bit_field.push_back(<b>false</b>);
        <a href="../../hello_world/counter.md#hello_world_counter">counter</a> = <a href="../../hello_world/counter.md#hello_world_counter">counter</a> + 1;
    };
